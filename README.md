...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/aiida-shell-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/aiida-shell-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add aiida-shell
# for installing globally
pixi global install aiida-shell
```
...
It is possible to list all of the versions of `aiida-shell` available on your platform:
...
```
pixi search aiida-shell --channel conda-forge
```
